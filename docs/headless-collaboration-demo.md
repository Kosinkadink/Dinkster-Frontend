...
The `@dinkster/headless-demo` workspace package is a Node 22+ participant for
shared workflow sessions. It can join a named session, discover the first
...
See `packages/headless-demo/README.md` for commands and flags.
