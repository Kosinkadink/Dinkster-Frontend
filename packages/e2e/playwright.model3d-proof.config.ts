...
const frontendPort = port('DINKSTER_MODEL3D_PROOF_FRONTEND_PORT', 5316)
const repoRoot = process.env['DINKSTER_MODEL3D_PROOF_REPO_ROOT'] ?? '../..'

export default defineConfig({
  testDir: './tests',
  testMatch: 'model3d-preview-proof.spec.ts',
  timeout: 60_000,
  workers: 1,
  use: {
