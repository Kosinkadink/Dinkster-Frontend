...
const frontendPort = port('DINKSTER_CANVAS_CHROME_FRONTEND_PORT', 5469)
const fixturePort = port('DINKSTER_CANVAS_CHROME_FIXTURE_PORT', 5479)
if (frontendPort === fixturePort) throw new Error('canvas chrome frontend and fixture ports must differ')

export default defineConfig({
  testDir: './tests',
  testMatch: 'canvas-navigation-chrome.spec.ts',
  timeout: 60_000,
  workers: 1,
  reporter: 'line',
  projects: [
